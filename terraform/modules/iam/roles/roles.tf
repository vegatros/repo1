...
resource "aws_iam_role" "AWSControlTowerExecution" {
  ...
  # WARNING: Control Tower requires specific permissions. Using PowerUserAccess + IAMFullAccess as minimum.
  # Review and scope down further based on actual Control Tower requirements.
  managed_policy_arns = ["arn:aws:iam::aws:policy/PowerUserAccess", "arn:aws:iam::aws:policy/IAMFullAccess"]
}
...
resource "aws_iam_role" "eks" {
  ...
  managed_policy_arns = ["arn:aws:iam::aws:policy/AmazonEKSClusterPolicy", "arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy", "arn:aws:iam::aws:policy/AmazonEKSServicePolicy", "arn:aws:iam::aws:policy/AmazonEKSFargatePodExecutionRolePolicy"]
}
...
resource "aws_iam_role" "Gitlab_Eks" {
  ...
  inline_policy {
    ...
    policy = jsonencode({ "Version" : "2012-10-17", "Statement" : [{ "Effect" : "Allow", "Action" : ["eks:DescribeCluster", "eks:ListClusters", "eks:AccessKubernetesApi", "eks:ListNodegroups", "eks:DescribeNodegroup", "eks:ListFargateProfiles", "eks:DescribeFargateProfile", "eks:ListUpdates", "eks:DescribeUpdate"], "Resource" : "arn:aws:eks:*:925185632967:cluster/*" }] })
  }
}
...
resource "aws_iam_role" "OrganizationAccountAccessRole" {
  ...
  # WARNING: Cross-account access from management account. Using PowerUserAccess + IAMFullAccess instead of AdministratorAccess.
  # Review based on actual organizational requirements.
  managed_policy_arns = ["arn:aws:iam::aws:policy/PowerUserAccess", "arn:aws:iam::aws:policy/IAMFullAccess"]
}
...
resource "aws_iam_role" "SNSFailureFeedback" {
  ...
  inline_policy {
    ...
    policy = jsonencode({ "Version" : "2012-10-17", "Statement" : [{ "Effect" : "Allow", "Action" : ["logs:CreateLogGroup", "logs:CreateLogStream", "logs:PutLogEvents"], "Resource" : ["arn:aws:logs:*:925185632967:log-group:sns/*", "arn:aws:logs:*:925185632967:log-group:sns/*:log-stream:*"] }] })
  }
}
...
resource "aws_iam_role" "vmimport" {
  ...
  inline_policy {
    ...
    policy = jsonencode({ "Version" : "2012-10-17", "Statement" : [{ "Effect" : "Allow", "Action" : ["s3:GetBucketLocation", "s3:GetObject", "s3:ListBucket"], "Resource" : ["arn:aws:s3:::vmimport-*", "arn:aws:s3:::vmimport-*/*"] }, { "Effect" : "Allow", "Action" : ["ec2:ModifySnapshotAttribute", "ec2:CopySnapshot", "ec2:RegisterImage", "ec2:DescribeImages", "ec2:DescribeSnapshots", "ec2:DescribeImportImageTasks", "ec2:DescribeImportSnapshotTasks"], "Resource" : "*" }] })
  }
}
...
resource "aws_iam_role" "workspaces_DefaultRole" {
  ...
  inline_policy {
    ...
    policy = jsonencode({ "Version" : "2012-10-17", "Statement" : [{ "Effect" : "Allow", "Action" : ["workspaces:DescribeWorkspaces", "workspaces:DescribeWorkspaceDirectories", "workspaces:DescribeWorkspaceBundles", "workspaces:RebootWorkspaces", "workspaces:RebuildWorkspaces", "workspaces:ModifyWorkspaceProperties"], "Resource" : "arn:aws:workspaces:*:925185632967:*" }] })
  }
  inline_policy {
    name   = "SkyLightServiceAccess"
    policy = jsonencode({ "Version" : "2012-10-17", "Statement" : [{ "Effect" : "Allow", "Action" : ["ec2:DescribeVpcs", "ec2:DescribeSubnets", "ec2:DescribeSecurityGroups", "ec2:DescribeInternetGateways", "ec2:DescribeRouteTables", "ec2:DescribeNetworkInterfaces", "ec2:CreateNetworkInterface", "ec2:DeleteNetworkInterface", "ec2:ModifyNetworkInterfaceAttribute", "ec2:CreateSecurityGroup", "ec2:AuthorizeSecurityGroupIngress", "ec2:AuthorizeSecurityGroupEgress"], "Resource" : "*" }, { "Effect" : "Allow", "Action" : ["workspaces:CreateWorkspaces", "workspaces:TerminateWorkspaces", "workspaces:ModifyWorkspaceState", "workspaces:StartWorkspaces", "workspaces:StopWorkspaces"], "Resource" : "arn:aws:workspaces:*:925185632967:*" }] })
  }
}
